        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-sm text-slate-500">
              <Link href="/account" className="font-medium text-[#1e3a5f] hover:underline">
                Profile
              </Link>
              <span className="mx-1.5 text-slate-300">/</span>
              Trips
            </p>
            <h1 className="mt-1 text-3xl font-bold text-black">My Trips</h1>
            <p className="mt-1 text-gray-600">Manage your upcoming stays and view past trips.</p>
          </div>
          {user ? (
            ...
            <Link href="/login?redirect=/account/trips" className="text-sm font-medium text-[#1e3a5f]">
              Sign in
            </Link>
          )}
        </div>
